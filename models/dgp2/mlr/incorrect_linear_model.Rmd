...
subtitle: "Incorrectly Specified Linear regression Model"
author: "Amos Okutse"
...
## save file on disk
write.csv(sim1_model_one, file = "/Users/aokutse/Library/CloudStorage/GoogleDrive-amos_okutse@brown.edu/Shared drives/amos/ThesisResults/data/dgp2/incorrect/sim1_model_one.csv", row.names = FALSE)
```
...
model_twoa <- function(df){
  ...
  set_mode("regression") %>% 
  set_engine("lm") %>% 
  fit(formula = y ~ A + x2 + x3 + x4, data = df) #adjustment model has no z1 here!!
## set A = 0 and generate predictions for everyone
  df_A0 <- df
  df_A0$A <- 0
  pred_A0 <- predict(lm_all, df_A0)
...
model_twoc <- function(df){
  ...
  set_mode("regression") %>% 
  set_engine("lm") %>% 
  fit(formula = y ~ A + x2 + x3 + x4, data = base::subset(df, R == 1))
## set A = 0 and generate predictions for everyone
  df_A0 <- df
  df_A0$A <- 0
  pred_A0 <- predict(lm_c, df_A0)
...
write.csv(sim1_model_two, file = "/Users/aokutse/Library/CloudStorage/GoogleDrive-amos_okutse@brown.edu/Shared drives/amos/ThesisResults/data/dgp2/incorrect/sim1_model_two.csv", row.names = FALSE)
```
...
## save file on disk
write.csv(sim2_model_one, file = "/Users/aokutse/Library/CloudStorage/GoogleDrive-amos_okutse@brown.edu/Shared drives/amos/ThesisResults/data/dgp2/incorrect/sim2_model_one.csv", row.names = FALSE)
```
...
write.csv(sim2_model_two, file = "/Users/aokutse/Library/CloudStorage/GoogleDrive-amos_okutse@brown.edu/Shared drives/amos/ThesisResults/data/dgp2/incorrect/sim2_model_two.csv", row.names = FALSE)
```
...
## save file on disk
write.csv(sim3_model_one, file = "/Users/aokutse/Library/CloudStorage/GoogleDrive-amos_okutse@brown.edu/Shared drives/amos/ThesisResults/data/dgp2/incorrect/sim3_model_one.csv", row.names = FALSE)
```
...
write.csv(sim3_model_two, file = "/Users/aokutse/Library/CloudStorage/GoogleDrive-amos_okutse@brown.edu/Shared drives/amos/ThesisResults/data/dgp2/incorrect/sim3_model_two.csv", row.names = FALSE)
```
