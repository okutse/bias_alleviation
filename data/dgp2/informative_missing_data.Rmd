...
## save all as one for simulation setting one data (one.RData)
...
## simulate 1000 data sets and save as a list for further analysis
cores <- parallel::detectCores()
doParallel::registerDoParallel(cores - 1)
...
## save all as one for simulation setting one data (two.RData)
